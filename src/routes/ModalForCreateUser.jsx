    ...
    <>
      {
        ...
        && <div className='absolute inset-0 flex bg-[#17171B] bg-opacity-70 justify-center items-center'>
          <div className='flex flex-col gap-1 justify-between items-center bg-[#17171B] rounded-3xl pt-10 md:h-[22rem] lg:h-[22rem] md:w-[30rem] lg:w-[30rem] shadow-2xl'>
            ...
            <div className='pt-8 flex w-full'>
              <button className='h-[4rem] bg-[#17171B] border-t-2 border-solid border-t-[#b248fe] rounded-bl-3xl rounded-br-3xl text-[#b248fe] w-full text-xl font-bold
